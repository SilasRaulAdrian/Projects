...
namespace Multiple_Levels_Game
{
    public partial class Level2Form : Form
    {
        ...
        private void gameTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                Level1Form newLevel = new Level1Form();
                this.Hide();
                gameTimer.Stop();
                gotKey = false;
                newLevel.Show();
        ...
        private void Level2Form_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Left)
                goLeft = false;
            if (e.KeyCode == Keys.Right)
        ...
        private void Level2Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
